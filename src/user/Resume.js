                        ...
                        <div className="col-lg-11">
                            <div className="row">
                                ...
                                <div class="col-lg-6" data-aos="fade-up" data-aos-delay="200">
                                    ...
                                    <div class="resume-item">
                                        <h4>MEAR Stack Traniee</h4>
                                        <h5>2023/4 - 2024/4</h5>
                                        <p><em>Tech Fly IT-Solution,Jodhpur </em></p>
                                        <ul>
                                            <li>Developed foundational skills in MongoDB, Express.js, React.js, and Node.js through intensive training and hands-on projects.s</li>
                                            ...
                                            <li>Deployed full-stack MERN applications on cloud platforms, ensuring scalability, security, and performance.</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
